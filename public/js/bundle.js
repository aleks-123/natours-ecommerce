...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWxla3MxMjMiLCJhIjoiY2w3a3NxejVtMHUzMjNvbWd1N2V2N2Q2eiJ9.rqWa0elGPHlSCY289X8pMg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/aleks123/cl7ktpxeh000315ryb02w3uvh/draft',
    scrollZoom: false // center: [-118.11391, 34.1117425],
    // zoom: 6,
    // interactive: false,
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Errpr loggig out! try again.');
...
var stripe = Stripe('pk_test_51LlfGOJqQLQIgy4ZnAGN8jYnypCDOPYiXWS0OQ7rMUGzjVvr6oORQhvoGk7U4lf1uk7frdgYv8ZyVvPuyEcPagA200w4D4y67s');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "45239" + '/');
