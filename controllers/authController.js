...
const createSendToken = (user, statusCode, res) => {
  const token = checkToken(user._id);
  const cookieOptions = {
    expires: new Date(
  ...
  // Remove password from the autpud
...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  // const message = `Forgot your password? Submit a PATCH request with your new password and passwrodConfritm to ${resetURL}. \nIf you didn't forget your password, please ignore this email`;
  try {
